function varargout = New_GUI_test(varargin)
% NEW_GUI_TEST MATLAB code for New_GUI_test.fig
%      NEW_GUI_TEST, by itself, creates a new NEW_GUI_TEST or raises the existing
%      singleton*.
%
%      H = NEW_GUI_TEST returns the handle to a new NEW_GUI_TEST or the handle to
%      the existing singleton*.
%
%      NEW_GUI_TEST('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in NEW_GUI_TEST.M with the given input arguments.
%
%      NEW_GUI_TEST('Property','Value',...) creates a new NEW_GUI_TEST or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before New_GUI_test_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to New_GUI_test_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help New_GUI_test

% Last Modified by GUIDE v2.5 03-Aug-2021 15:55:38

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @New_GUI_test_OpeningFcn, ...
                   'gui_OutputFcn',  @New_GUI_test_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before New_GUI_test is made visible.
function New_GUI_test_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to New_GUI_test (see VARARGIN)

% Choose default command line output for New_GUI_test
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes New_GUI_test wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = New_GUI_test_OutputFcn(hObject, eventdata, handles) 
